...
M[11].collider = {}
M[11].collider.GroupX = {300, 400, 700, 800}
M[11].collider.GroupY = {170, 225, 170, 170}
M[11].collider.Num = {8, 7, 8, 8}
M[11].collider.Orientation = {2, 2, 2, 2}
M[11].collider.ColliderType = {2, 1, 2, 1}

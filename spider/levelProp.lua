...
M[1].bg.ExtraImg = {"tap_here.png", "tap_here2.png"}
M[1].bg.ExtraImgOpacity = {1, 0}
M[1].bg.ExtraImgX = {90, 935}
M[1].bg.ExtraImgY = {150, 100}
M[1].bg.ExtraImgWidth = {285, 550}
M[1].bg.ExtraImgHeight = {457, 162}
M[1].bg.ExtraImgScale = {0.2, 0.2}

...
M[11].portal.Types = {5, 2}
M[11].portal.PosiX = {{458,OOF}, {508,-OOF}}
M[11].portal.PosiY = {{63, OOF}, {253,-OOF}}
...
M[11].dos_donts = {}
M[11].dos_donts.Img = "dos_donts_10.png"
M[11].dos_donts.Color = {0.3, 0.1, 0.2, 1}
